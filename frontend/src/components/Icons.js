...
import { faTrash, faEdit, faPlus, faExpand, faMagnifyingGlass, faPen, faXmark} from "@fortawesome/free-solid-svg-icons";
...
export const UpdateIcon = <FontAwesomeIcon icon={faPen} />
